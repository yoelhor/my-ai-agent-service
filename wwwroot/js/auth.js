...
console.log(currentAccounts);
    if ((!currentAccounts) || currentAccounts.length === 0) {
        ...
        console.log("Single account detected.");
...
function handleResponse(resp) {
    if (resp !== null) {
        ...
        showWelcomeMessage(resp.account.username);
    } else {
        selectAccount();
    }
}
...
function showWelcomeMessage(account) {
    ...
    welcomeDiv.innerHTML = `Welcome ${account}!`;

    // Hide the sign-in button once signed in and show the sign-out button
